...
contract FlightSuretyData {
    ...
    */
    ...
    /**
     * @dev Modifier that requires the Airline be isRegistered
     */
     ...
     *
     */
    function addAirline (address hasFundAirline, address newAirline, string name)
     ...
     *
     */
    function _addAirline (address newAirline, string name) private {
    ...
    function _registerAirline(address applicantAirline) private {
        airlines[applicantAirline].isRegistered = true;
    }
    ...
    */
    ...
    /**
     * @dev Check Airline isRegistered
     */
